...
package com.uom.msc.cse.sdoncloud.aggregator.application.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select().apis(RequestHandlerSelectors.basePackage("com.uom.msc.cse.sdoncloud.aggregator.application.controller"))
                .paths(regex("/.*"))
                .build()
